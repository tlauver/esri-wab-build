...
function copyAppBuildPackages(from, to) {
  ...
  docopy(path.join(from, "dojo/NodeList-data.js"), path.join(to, "arcgis-js-api/dojo/NodeList-data.js"));
  ...
  docopy(path.join(from, "esri/tasks/support/pbfDeps.js"), path.join(to, "rcgis-js-api/esri/tasks/support/pbfDeps.js"));
